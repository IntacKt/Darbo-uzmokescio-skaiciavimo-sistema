...
public class LeaveStatus extends JFrame {
	...
	public LeaveStatus() {
		...
		separator.setBounds(16, 56, 546, 2);
		contentPane.add(separator);
		
		JLabel lblNewEntry = new JLabel("Leave Status");
		lblNewEntry.setBounds(247, 11, 117, 34);
		...
		separator_1.setBounds(305, 119, 2, 219);
		...
		srchfldEnterempId.setBounds(219, 78, 174, 22);
		srchfldEnterempId.setFont(new Font("Tahoma", Font.ITALIC, 11));
	
		
		String[] l = new String[]{"	------Select------", "Sick Leave","Vacation Leave","Casual Leave","Convention Leave"};
		...
		lblJanuary.setBounds(334, 122, 46, 14);
		contentPane.add(lblJanuary);
		
		textField_15 = new JTextField();
		textField_15.setBounds(393, 119, 40, 20);
		contentPane.add(textField_15);
		textField_15.setColumns(10);
		
		textField_16 = new JTextField();
		textField_16.setColumns(10);
		textField_16.setBounds(393, 158, 40, 20);
		contentPane.add(textField_16);
		
		textField_17 = new JTextField();
		textField_17.setColumns(10);
		textField_17.setBounds(393, 186, 40, 20);
		contentPane.add(textField_17);
		
		textField_18 = new JTextField();
		textField_18.setColumns(10);
		textField_18.setBounds(393, 217, 40, 20);
		contentPane.add(textField_18);
		
		textField_19 = new JTextField();
		textField_19.setColumns(10);
		textField_19.setBounds(393, 248, 40, 20);
		contentPane.add(textField_19);
		
		textField_20 = new JTextField();
		textField_20.setColumns(10);
		textField_20.setBounds(393, 279, 40, 20);
		contentPane.add(textField_20);
		
		textField_21 = new JTextField();
		textField_21.setColumns(10);
		textField_21.setBounds(522, 119, 40, 20);
		contentPane.add(textField_21);
		
		textField_22 = new JTextField();
		textField_22.setColumns(10);
		textField_22.setBounds(522, 150, 40, 20);
		contentPane.add(textField_22);
		
		textField_23 = new JTextField();
		textField_23.setColumns(10);
		textField_23.setBounds(522, 186, 40, 20);
		contentPane.add(textField_23);
		
		textField_24 = new JTextField();
		textField_24.setColumns(10);
		textField_24.setBounds(522, 217, 40, 20);
		contentPane.add(textField_24);
		
		textField_25 = new JTextField();
		textField_25.setColumns(10);
		textField_25.setBounds(522, 248, 40, 20);
		contentPane.add(textField_25);
		
		textField_26 = new JTextField();
		textField_26.setColumns(10);
		textField_26.setBounds(522, 279, 40, 20);
		contentPane.add(textField_26);
		
		JLabel lblFebruary = new JLabel("February");
		lblFebruary.setBounds(335, 161, 70, 14);
		contentPane.add(lblFebruary);
		
		JLabel lblMarch = new JLabel("March");
		lblMarch.setBounds(334, 189, 40, 14);
		contentPane.add(lblMarch);
		
		JLabel lblApril = new JLabel("April");
		lblApril.setBounds(334, 220, 30, 14);
		contentPane.add(lblApril);
		
		JLabel lblMay = new JLabel("May");
		lblMay.setBounds(334, 251, 30, 14);
		contentPane.add(lblMay);
		
		JLabel lblJune = new JLabel("June");
		lblJune.setBounds(334, 282, 30, 14);
		contentPane.add(lblJune);
		
		JLabel lblJuly = new JLabel("July");
		lblJuly.setBounds(456, 122, 30, 14);
		contentPane.add(lblJuly);
		
		JLabel lblAugust = new JLabel("August");
		lblAugust.setBounds(456, 150, 40, 14);
		contentPane.add(lblAugust);
		
		JLabel lblSeptember = new JLabel("September");
		lblSeptember.setBounds(456, 189, 89, 14);
		contentPane.add(lblSeptember);
		
		JLabel lblOctober = new JLabel("October");
		lblOctober.setBounds(456, 220, 46, 14);
		contentPane.add(lblOctober);
		
		JLabel lblNovember = new JLabel("November");
		lblNovember.setBounds(456, 251, 78, 14);
		contentPane.add(lblNovember);
		
		JLabel lblDecember = new JLabel("December");
		lblDecember.setBounds(456, 282, 78, 14);
		contentPane.add(lblDecember);
		
		JButton btnCancel = new JButton("Cancel");
		btnCancel.setBounds(334, 356, 89, 23);
		contentPane.add(btnCancel);
		
		JLabel label_1 = new JLabel("");
		label_1.setBounds(191, 390, 232, 14);
		contentPane.add(label_1);
		
		
		textField_27 = new JTextField();
		textField_27.setBounds(456, 316, 89, 20);
		...
		btnTotal.setBounds(334, 315, 89, 23);
